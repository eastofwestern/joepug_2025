...
<footer>
	...
	<div class="inner">
		<div class="animated_name" style="color: <?= $footerLogoDetails['bgColor'] ?>;">
			...
			<div class="last_name" style="background-color: <?= $catDetails['bgColor'] ? $catDetails['bgColor'] : '#fff' ?>;">

				<div class="spacer" style="background-color: <?= $catDetails['bgColor'] ? $catDetails['bgColor'] : '#fff' ?>;"></div>

				<svg id="pug" xmlns="http://www.w3.org/2000/svg" width="348.957" height="151.386" viewBox="0 0 348.957 151.386" style="background-color: <?= $catDetails['bgColor'] ? $catDetails['bgColor'] : '#fff' ?>;">
				...
				<svg id="liese" xmlns="http://www.w3.org/2000/svg" width="313.757" height="151.385" viewBox="0 0 313.757 151.385" style="background-color: <?= $catDetails['bgColor'] ? $catDetails['bgColor'] : '#fff' ?>;">
