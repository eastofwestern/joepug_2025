...
function getImages($catID, $theSort = "drag")
{
	...
	$sql = "SELECT pics.*, cat_pics.rowBreak as catBreak, cat_pics.imgSize as catSize, content.content FROM pics JOIN cat_pics ON pics.id = cat_pics.picid LEFT JOIN content ON content.picid = pics.id WHERE cat_pics.catid = '$catID'";
