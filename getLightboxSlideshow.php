...
<div class="wrap">
    ...
    <div class="slideshow data-flickity">
        ...
        <svg class="close" id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 136.89 136.89">
            <defs>
                <style>
                    .close-1 {
                        opacity: .6;
            ...
            <g id="Layer_1-2">
                <g class="close-1">
                    <path class="cls-2" d="M68.45,0C30.64,0,0,30.64,0,68.45s30.64,68.45,68.45,68.45,68.45-30.64,68.45-68.45S106.25,0,68.45,0ZM110.32,108.59h-16.77l-17.91-21.47c-1.8-2.3-4.2-4.99-7.19-4.99s-5.4,2.69-7.19,4.99l-17.92,21.47h-16.77l33.68-40.15L26.57,28.3h16.77l17.92,21.47c1.8,2.3,4.2,4.99,7.19,4.99s5.4-2.69,7.19-4.99l17.92-21.47h16.77l-33.68,40.15,33.68,40.15Z" />
                </g>
            </g>
        </svg>
