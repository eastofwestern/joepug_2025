...
function getImages($catID, $theSort = "drag")
{
	...
	$sql = "SELECT pics.*, cat_pics.rowBreak as catBreak, cat_pics.imgSize as catSize, cat_pics.width as catWidth, cat_pics.pos_top as catTop, cat_pics.pos_left as catLeft, cat_pics.layer as catLayer, cat_pics.width_mobile as catWidthMobile, cat_pics.pos_top_mobile as catTopMobile, cat_pics.pos_left_mobile as catLeftMobile, cat_pics.layer_mobile as catLayerMobile FROM pics JOIN cat_pics ON pics.id = cat_pics.picid WHERE cat_pics.catid = '$catID'";
