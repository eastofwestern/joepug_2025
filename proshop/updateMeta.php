...
if (isset($_FILES['file']['name'])) {
	...
	$location = $save_path . $catID . "_" . "meta_" . $filename;
	...
	// GET IMAGE SIZE
	$imgSize = getimagesize($save_path . $catID . "_" . "meta_" . $filename);
	$previewWidth = $imgSize[0];
	$previewHeight = $imgSize[1];

	$previewImage = $catID . "_" . "meta_" . $filename;
}

$query = "UPDATE cat_list SET metaTitle = '$metaTitle', metaDesc = '$metaDesc', metaKeywords = '$metaKeywords', metaImage = '$previewImage', metaImageWidth = '$previewWidth', metaImageHeight = '$previewHeight' WHERE id = '$catID'";
