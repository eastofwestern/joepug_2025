...
(0, _gsapDefault.default).registerPlugin((0, _flipDefault.default), (0, _scrollTriggerDefault.default), (0, _scrollSmootherDefault.default), (0, _observerDefault.default));
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    looseGrids.forEach((looseGrid)=>{
        ...
        function updatePositions() {
            ...
            items.forEach((item)=>{
                ...
                (0, _gsapDefault.default).set(item, {
                    x: 0,
                    y: 0,
                    z: 0
                });
        ...
        function updateContainerHeight() {
            ...
            requestAnimationFrame(()=>{
                let maxBottom = 0;
                items.forEach((item)=>{
                    let topPos = (0, _gsapDefault.default).getProperty(item, "top"); // Get the top position in pixels
    ...
    const handleSlideshowClick = (e)=>{
        ...
        } else // check if this is the last image in slideshow, if it is last, close lightbox
    ...
    if (window.innerWidth > 768) footerTL.to(mask, {
        ...
        lightboxSingleLinks.forEach((lightboxLink)=>{
            lightboxLink.addEventListener("click", function(e) {
                ...
                getAjax("/getLightboxSingle.php?picid=" + picid, function(data) {
                    ...
                    initLoading();
                    document.querySelector("#lightbox .closeIcon").addEventListener("click", function(e) {
                        e.preventDefault();
            ...
            overlayLink.addEventListener("click", function(e) {
                ...
                if (parentCell.classList.contains("selected")) {
                    ...
                    getAjax("/getItem.php?id=" + id, function(data) {
                        ...
                        initLoading();
                        setTimeout(function() {
                            (0, _zenscrollDefault.default).center(overlayInner);
                        }, 100);
...
},{"vanilla-lazyload":"jxeny","f37633aef5bfd82":"kY7us","social-icons":"896BE","ar-rows":"6m4AN","gsap":"iwVsn","gsap/ScrollTrigger":"6ECdG","gsap/ScrollSmoother":"jxa5v","gsap/Flip":"aNmT5","gsap/Observer":"7RiFS","zenscroll":"7ddEv","@parcel/transformer-js/src/esmodule-helpers.js":"B6NKQ"}],"jxeny":[function(require,module,exports) {
!function(n, t) {
    module.exports = t();
}(this, function() {
    "use strict";
